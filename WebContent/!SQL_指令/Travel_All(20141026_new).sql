...
insert into images values ('C_Oiwake_Station_02','Oiwake_Station','追分火車站是台鐵海線的終點站，是少數未經過改建的海線車站之一。追分原為日文的oiwake，是分岐路的意思。由於台灣曾經受日本人統治長達50年之久，因此台灣多處地名大多由日語漢字命名而成。','','');
...
insert into sysmember values ('aaa123','bbb123','aa123@gmail.com',1,'王中平','N','男','2014-01-01','台北市大安區','2014-02-02','2011-06-18','A');
insert into sysmember values ('bbb123','ccc123','bb123@gmail.com',2,'謝霆鋒','N','男','2013-10-05','台北市大安區','2014-01-06','2011-06-18','B');
insert into sysmember values ('ccc123','ddd123','cc123@yahoo.com.tw',3,'張柏芝','N','男','2012-08-11','台北市大安區','2013-10-02','','C');
insert into sysmember values ('ddd123','eee123','dd123@gmail.com',4,'羅志祥','N','男','2011-07-01','台北市大安區','2012-08-07','','A');
insert into sysmember values ('eee123','aaa123','ee123@yahoo.com.tw',5,'周杰倫','N','男','2010-11-21','台北市大安區','2011-06-18','','C');
insert into sysmember values ('fff123','ggg123','aa123@gmail.com',1,'蔡依林','N','男','2014-01-01','台北市大安區','2014-02-02','2011-06-18','A');
insert into sysmember values ('ggg123','hhh123','bb123@gmail.com',2,'楊丞琳','N','男','2013-10-05','台北市大安區','2014-01-06','2011-06-18','B');
insert into sysmember values ('hhh123','iii123','cc123@yahoo.com.tw',3,'吳宗憲','N','男','2012-08-11','台北市大安區','2013-10-02','','C');
...
CREATE TABLE knowledge ( 
 ...
 knowledge_content			nvarchar(max)		not null,
...
CREATE CLUSTERED INDEX ContactUs_Index ON ContactUs (contactUsId);
