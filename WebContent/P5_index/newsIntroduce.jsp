...
<html>
  ...
  <%
    String newsIdentity = session.getAttribute("newsIdentity").toString();
  	newsService nsSvc = new newsService();
  	newsVO nsVO = nsSvc.getOne(newsIdentity);
  %>
...
<div class="container">
	<div class="row">
            ...
            <div class="col-md-12" style="float:left;display:inline;">
            	<h1><%=nsVO.getNews_title() %></h1>
            	<img style="float:right;margin:15px;width:450px;height:300px;" src="GetNewsImgServlet?news_Identity=<%=newsIdentity%>" align="right" />
            	<h3 style="  letter-spacing:4px;  line-height:30px; ">
            		<%=turn(nsVO.getNews_Content())%>
<%--             		　<%=turn(rs.getString("content"))%>  --%>
